...
namespace Nova.InternalNamespace_17.InternalNamespace_18
{
    ...
    internal class InternalType_582 : InternalType_583<InternalType_601>
    {
        protected override void OnGUI(Rect position, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(InternalVar_1, InternalField_2604.InternalProperty_576);
            EditorGUI.PropertyField(InternalVar_2, InternalField_2604.InternalProperty_578);
            EditorGUI.PropertyField(InternalVar_3, InternalField_2604.InternalProperty_580);
